...
[ -e "./data/Usagi.txt" ] && rm ./data/Usagi.txt
...
java -classpath ../bin Usagi < input1.txt > ACTUAL1.TXT
...
# run #2: new process; should load from data/Usagi.txt and list
java -classpath ../bin Usagi < input2.txt > ACTUAL2.TXT
